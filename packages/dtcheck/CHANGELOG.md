...
This log was last generated on Tue, 24 Sep 2024 22:41:22 GMT and should not be manually modified.

## 0.50.1
Tue, 24 Sep 2024 22:41:22 GMT
...
- Add new getDatatype(input) return data type of input with custom settings support
- Add more apis for checking datatypes in javascript and/or getting datatypes
...
- Remove esm import allow esm to use commonjs instead
